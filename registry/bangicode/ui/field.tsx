...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        "mb-3 font-hanken-grotesk font-medium",
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "font-hanken-grotesk text-sm leading-normal font-normal text-muted-foreground group-has-[[data-orientation=horizontal]]/field:text-balance",
...
function FieldSeparator({
  ...
  return (
    ...
    >
      ...
      {children && (
        <span
          className="relative mx-auto block w-fit bg-background px-2 font-hanken-grotesk text-muted-foreground"
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn("font-hanken-grotesk text-sm font-normal text-destructive", className)}
      {...props}
    >
      {content}
    </div>
